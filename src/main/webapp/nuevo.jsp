...
<form action="bolo?op=crear" method="post">	
	...
	<input type="text" name="banda1" id= "banda1" class="form-control" >			    
	</div>
	
	<div class="form-group">
	<label for="banda2">Banda 2</label>
	<input type="text" name="banda2" id= "banda2" class="form-control" >			    
	</div>
	
	<div class="form-group">
	<label for="banda3">Banda 3</label>
	<input type="text" name="banda3" id= "banda3" class="form-control" >			    
	</div>
